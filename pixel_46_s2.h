...
byte oneSecond[] = { 0, 2, 4, 6, 8, 10, 12, 14, 16 };           //09
byte tenSecond[] = { 20, 22, 24, 26, 28 };                  //15,16
byte oneMinute[] = { 34, 36, 38, 40, 42, 44, 46, 48, 50 };  //26
byte tenMinute[] = { 54, 56, 58, 60, 62 };                  //32,33
byte oneHour[] = { 68, 70, 72, 74, 76, 78, 80, 82, 84 };    //43
byte tenHour[] = { 88, 90 };
byte Separator[] = { 18, 30, 32, 52, 64, 66, 86 };
